...
local freecad     = "flatpak run org.freecad.FreeCAD"
local keepassxc   = "flatpak run org.keepassxc.KeePassXC"
local nextcloud   = "flatpak run com.nextcloud.desktopclient.nextcloud"
...
hl.config({
    general = {
        ...
        col = {
            active_border = { colors = {catppuccin.mauve, catppuccin.lavender}, angle = 45 },
...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("hyprshutdown -t 'Logging out...' || hyprctl dispatch 'hl.dsp.exit()'"))
...
hl.bind(mainMod .. " + Y", hl.dsp.exec_cmd(freetube))
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(freecad))
...
hl.bind("SHIFT + PRINT",  hl.dsp.exec_cmd("hyprshot -m output -m DP-1"))
...
hl.window_rule({
    name = "keepassxc to magic",
    match = { class = "org.keepassxc.KeePassXC" },
    workspace = "special:magic silent",
})

hl.window_rule({
    name = "nextcloud to magic",
    match = { class = "com.nextcloud.desktopclient.nextcloud" },
    workspace = "special:magic silent",
})

hl.window_rule({
    name = "Pixel2VoxelLive to fullscreen",
    match = { title = "Pixel2VoxelLive" },
    fullscreen = true
})
